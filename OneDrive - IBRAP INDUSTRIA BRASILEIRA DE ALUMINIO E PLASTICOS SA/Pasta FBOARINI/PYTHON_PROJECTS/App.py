...
class Application:
    def __init__(self, master=None):
        ...
        self.titulo = Label(self.container1, text="Cadastro de Usuários - CRUD.py")
        self.titulo["font"] = ("Calibri", "10", "bold")
        self.titulo.pack ()
        ...
        self.btnBuscar = Button(self.container2, text="Buscar", font=self.fonte, width=9)
